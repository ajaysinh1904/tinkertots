...
function NotFound() {
  return (
    <div className="bg-cream min-h-[70vh] flex flex-col items-center justify-center py-20 px-4 text-center">
      <div className="bg-white border-3 border-navy rounded-[50%] p-4 shadow-[6px_6px_0px_0px_#1A1A2E] mb-6 transform rotate-[-4deg]">
      ...
      <Link
        to="/"
        className="mt-8 px-6 py-3 bg-coral text-white font-accent rounded-xl border-2 border-navy shadow-[4px_4px_0px_0px_#1A1A2E] hover:translate-y-[-1px] transition-all"
      >
        Back to Home ➔
      </Link>
    </div>
